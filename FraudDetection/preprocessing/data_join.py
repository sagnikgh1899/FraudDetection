...
def read_data():
    ...
    """
    try:
        fraud=pd.read_csv("./FraudDetection/data/Train-1542865627584.csv")
        beneficiary=pd.read_csv("./FraudDetection/data/Train_Beneficiarydata-1542865627584.csv")
        inpatient=pd.read_csv("./FraudDetection/data/Train_Inpatientdata-1542865627584.csv")
        outpatient=pd.read_csv("./FraudDetection/data/Train_Outpatientdata-1542865627584.csv")
...
def join_csv(fraud, beneficiary, inpatient, outpatient):
    ...
    merged.to_csv('./FraudDetection/data/merged.csv', index=False)
